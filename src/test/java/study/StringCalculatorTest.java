...
public class StringCalculatorTest {
    ...
    void input_empty_is_return_zero() {
        int resultNumber = StringCalculator.stringToNumberMultiply("");
    ...
    void input_one_number_is_return_this() {
        int resultNumber = StringCalculator.stringToNumberMultiply("3");
    ...
    void split_string_with_comma_return_sum() {
        int resultNumber = StringCalculator.stringToNumberMultiply("1,2,3");
    ...
    void input_negative_return_exception() {
        assertThatThrownBy(() -> StringCalculator.stringToNumberMultiply("-1,2,3"))
